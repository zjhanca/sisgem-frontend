...
const formVacio = { nombre: '', apellido: '', email: '', password: '', telefono: '', rol_id: '' }
...
export default function Usuarios() {
  ...
  const validar = () => {
    ...
    if (!modal.item && form.password && form.password.length < 6)
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="campo-label">
                {modal.item ? 'nueva contrasena' : 'contrasena *'}
              </label>
        ...
        {modalDetalle.item && (
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                <p className="campo-label">rol</p>
                <p className="text-light-text dark:text-dark-text">
                  {modalDetalle.item.rol}
                </p>
              </div>
            </div>
            <div className="flex justify-end gap-2 pt-2 border-t border-gray-200 dark:border-dark-border">
