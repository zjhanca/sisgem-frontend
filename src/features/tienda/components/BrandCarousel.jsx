...
export default function BrandCarousel({ marcas }) {
  ...
  return (
    <section>
      <h2 className="text-sm font-bold text-light-text dark:text-dark-text tracking-wide uppercase mb-4">Marcas</h2>
        ...
        <div className="flex-1 grid grid-cols-6 gap-4">
          {visibles.map(m => (
            <div key={m.id} className="flex flex-col items-center gap-2">
              <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-gray-100 dark:border-dark-border
                ...
                {m.logo ? (
                  <>
                    ...
                    <div className="hidden w-full h-full items-center justify-center bg-primary/10 font-bold text-primary text-xl">
