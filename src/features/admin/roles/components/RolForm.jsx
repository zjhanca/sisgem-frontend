        ...
        {tab === 'permisos' && (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <p className="text-xs text-gray-500">{permisosSeleccionados.length} de {todosPermisos.length} permisos seleccionados</p>
              <div className="flex gap-2">
                <button type="button" onClick={seleccionarTodos} className="text-xs text-primary hover:underline">Seleccionar todos</button>
                ...
                return (
                  <div key={modulo} className="border border-gray-200 dark:border-dark-border rounded-lg overflow-hidden">
                    ...
                    <div className="grid grid-cols-2 gap-px bg-gray-100 dark:bg-dark-border">
                      {perms.map(p => (
                        <label key={p.id} className="flex items-center gap-2 px-3 py-2 text-xs cursor-pointer bg-light-card dark:bg-dark-card hover:bg-primary/5 transition-colors">
