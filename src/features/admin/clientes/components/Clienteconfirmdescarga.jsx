...
export default function ClienteConfirmDescarga({ abierto, setAbierto, descargarReporte }) {
    ...
    <Modal abierto={abierto} onCerrar={cerrar} bloquearCierre titulo="Descargar Reporte" ancho="max-w-sm">
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          ¿Deseas descargar el <span className="font-semibold text-light-text">reporte de clientes</span>?
        </p>
