...
export default function ProductoEliminar({ modalEliminar, setModalEliminar, eliminar, eliminando }) {
  ...
  return (
    <Modal abierto={modalEliminar.abierto} onCerrar={cerrar} bloquearCierre
      ...
      <div className="space-y-4">
        <p className="text-sm">¿Eliminar <span className="font-medium text-primary">{item?.nombre}</span>?
