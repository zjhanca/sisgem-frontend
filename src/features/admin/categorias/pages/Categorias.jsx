    ...
    <div>
      ...
      <Tabla
        ...
        acciones={fila => (<>
          ...
          <button onClick={() => setModalMargen({ abierto: true, item: fila })} className="btn-ghost" title="Cambiar margen">
            <Percent size={14} />
          </button>
      ...
      <CategoriaMargen modalMargen={modalMargen} setModalMargen={setModalMargen} actualizarMargen={actualizarMargen} />
    </div>
  )
}