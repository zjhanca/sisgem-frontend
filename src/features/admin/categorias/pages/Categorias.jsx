    ...
    <div>
      ...
      <Tabla columnas={columnas} datos={categorias}
        acciones={fila => (<>
          ...
          <button onClick={() => abrirMargen(fila)} className="btn-ghost" title="Cambiar margen"><Percent size={14} /></button>
      ...
      <CategoriaMargen modalMargen={modalMargen} setModalMargen={setModalMargen}
        margenInput={margenInput} setMargenInput={setMargenInput} actualizarMargen={actualizarMargen} />
    </div>
  )
}